...
namespace PeartreeGames.EvtMenus
{
    ...
    public static class Easings
    {
        ...
        public static class Quadratic
        {
            ...
            public static float InOut(float v) => (v *= 2f) < 1f ? 0.5f * In(v) : -0.5f * ((v -= 1f) * (v - 2f) - 1f);
        }
        ...
        public static class Cubic
        {
            ...
            public static float InOut(float v) => (v *= 2f) < 1f ? 0.5f * In(v) : 0.5f * ((v -= 2f) * v * v + 2f);
        }
        ...
        {
            public static float In(float v) => Mathf.Abs(v) < Mathf.Epsilon ? 0f : Mathf.Pow(1024f, v - 1f);
            public static float Out(float v) => Mathf.Abs(v - 1f) < Mathf.Epsilon ? 1f : 1f - Mathf.Pow(2f, -10f * v);
        ...
        public static class Bounce
        {
            ...
            public static float InOut(float v) => v < 0.5f ? In(v * 2f) * 0.5f : Out(v * 2f - 1f) * 0.5f + 0.5f;
        }
    }
}